...
function HtmlBuilder() {
    ...
    const textFieldFunction = async (memberId, assessmentId, questionId) => {
        ...
        if (optionid != 0) {
            ...
            value = htmlValue[0].length > 0 ? htmlValue[0][0].OptionValue : '';
            ...
            value = htmlValue[0].length > 0 ? htmlValue[0][0].AnswerText : '';
        }
    ...
    const HtmlEditor = async (memberId, assessmentId, questionId) => {
        ...
        value = htmlValue[0].length > 0 ? htmlValue[0][0].Html : '';
    ...
    const RadioBoxFuction = async (memberId, assessmentId, questionId) => {
        ...
        if (optionid != 0) {
            ...
            const mydata = questionAnswers[0];
